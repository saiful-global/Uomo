  ...
  return (
    <div className='max-w-82.5 relative'>
      ...
      <div className='group'>
        ...
        {/* Hover: ADD TO CART */}
        <div className='bg-white shadow shadow-gray-200 text-center group-hover:bottom-30 group-hover:opacity-100 absolute bottom-15 pt-4 pb-2.5 w-77.5 left-1/2 translate-x-[-50%] duration-200 opacity-0 transition-all'>
        ...
        <div className='flex justify-between'>
          <div>
            ...
            <h2 className='font-jost text-primary-black text-base font-normal'>{item.title}</h2>
