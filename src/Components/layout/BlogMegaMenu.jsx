export default function BlogMegaMenu() {
  return (
    <div
      ...
      w-198.75 bg-white border-t border-bg-footer
      shadow-[0_10px_40px_rgba(0,0,0,0.08)] opacity-0 invisible -translate-y-3
      group-hover:opacity-100 group-hover:visible group-hover:translate-y-0
      transition-all duration-300 hidden lg:block z-50
      "
    >
