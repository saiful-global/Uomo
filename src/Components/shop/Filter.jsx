      ...
      {filterModal && (
        ...
        <div className={`h-screen ${filterModal? "w-full md:w-105": "w-0"} bg-primary-white top-0 right-0 fixed z-50 duration-300 overflow-y-auto scroll-smooth`}>
          ...
          <div className='pl-8.5 pr-10 md:px-10 mx-auto pt-9.5'>
            ...
            {/* Tags  */}
            <div className="flex flex-wrap gap-4.25 items-center pb-50 font-jost font-normal text-[11px]">

              <div className="flex items-center gap-2.5 bg-[#EEEEEE] px-3.75 cursor-pointer hover:bg-primary-black hover:text-white leading-7.5">
                <span>✕</span>
                <span>Blues</span>
              </div>
